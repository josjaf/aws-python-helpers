class Constants():
    ...
    accounts_list = {
        ...
        '088746295286-artifact-pipeline': {
            'account_id': '088746295286',
            'profile': 'shared',
            'region': 'us-east-1',
            'env_file': f'conf/088746295286-artifact-pipeline.env',
            'config_file': 'artifact_pipeline.yml'
        },
        '088746295286-security-app-pipeline': {
            'account_id': '088746295286',
            'profile': 'shared',
            'region': 'us-east-1',
            'env_file': f'conf/088746295286-security-app-pipeline.env',
            'config_file': 'security_app_pipeline.yml'
        }
    }